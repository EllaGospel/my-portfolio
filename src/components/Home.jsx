      ...
      <div name="home" className='bg-gradient-to-b  via-white from-orange-300 to-orange-300 h-full w-full pt-16 pb-16 lg:pt-20' >
            ...
            <div>
                ...
                <div className='flex flex-col mt-4 h-full ml-2 mb-[10px} xl:justify-center'>
                    <h2 className='text-5xl sm:text-5xl font-bold'>I'm a frontend<br/> Developer</h2>
                    <p className='text-gray py-4 max-w-md'>A frontend Developer focused on building  frontend user interface that leads to the success of overall product</p>
                    <div >
